...
{\large A Personalised Learning Platform with}\\
{\large Collaborative Filtering Recommendations}\\[2.5cm]
...
\textbf{Supervisor:} & Trương Trọng Tuấn \\
\end{tabular}
\end{flushleft}
...
I hereby declare that this thesis, titled ``Opic -- A Personalised Learning Platform with Collaborative Filtering Recommendations'', is the result of my own work carried out under the guidance of my supervisor. All sources of information, data, figures, and prior work used in this report have been duly acknowledged and cited. The system, experiments, and results presented here are genuine and have not been submitted, in whole or in part, for any other degree or qualification.
...
Online learning has become a primary mode of self-directed education for university students, yet the sheer volume of available resources often makes it difficult to know what to study, in what order, and which materials are actually worth the time. This thesis presents \textbf{Opic}, a web-based personalised learning platform that addresses these three challenges through structured topic roadmaps, a community-driven content pipeline with administrator review, and a collaborative filtering recommendation engine.
...
\begin{figure}[H]
\centering
\IfFileExists{ucd_auth.png}{\includegraphics[width=0.75\textwidth]{ucd_auth.png}}{\missingfig{ucd\_auth.png}{Overall Use Case Diagram}}
\caption{Overall Use Case Diagram -- Authentication Sub-module}
